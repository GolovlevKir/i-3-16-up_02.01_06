...
{
    public partial class ConfCon : Form
    {
        ...
        private void ConfCon_Load(object sender, EventArgs e)
        {
        ...
        private void ConfCon_FormClosing(object sender, FormClosingEventArgs e)
        {
            switch (DataBase_Configuration.logCon)
            {
                case (true):
                ...
                case (false):
                    switch (MessageBox.Show("Подключение не было уствновлено! " +
                        "\n Завершить работу приложения?", "Ортопедический салон",
